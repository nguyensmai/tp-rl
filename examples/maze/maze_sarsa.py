...
if __name__ == '__main__':
    ...
    for x in range(total_episodes):
        ...
        if x%1000==0:
            print("")
            print("Epsilon: " + str(sarsa.epsilon))
            print("State-Action matrix after " + str(x+1) + " iterations:") 
            print(sarsa.q)
            print("Policy matrix after " + str(x+1) + " iterations:") 
            env.print_policy(sarsa.q)
